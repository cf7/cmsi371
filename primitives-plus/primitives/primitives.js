...
var Primitives = {
    ...
    plotCirclePoints: function (context, xc, yc, x, y, color, color2, color3, color4) {
        ...
        // var bottom = yc + h;
        // var right = xc + w;
        // var leftColor = color ? [color[0], color[1], color[2]] : color;
    ...
    // Now DDA.
    circleDDA: function (context, xc, yc, r, color, color2, color3, color4) {
        var epsilon = 1 / r;
        var x = r;
        var y = 0;
    ...
    circleBres1: function (context, xc, yc, r, color, color2, color3, color4) {
        var p = 3 - 2 * r;
        var x = 0;
        var y = r;
    ...
    // Last but not least...
    circleBres3: function (context, xc, yc, r, color, color2, color3, color4) {
        var x = r;
        var y = 0;
        var e = 0;
